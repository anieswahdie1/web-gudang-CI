...
<head>
  ...
  <title>Gudang.in | Dashboard</title>
  ...
  <!-- Date Picker : untuk menampilkan kalender virtual -->
  ...
  <!-- Daterange picker : membatasi tanggal keluar agar tidak dibawah tanggal masuk -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('admin')?>" class="logo">
      ...
      <span class="logo-mini"><b>Gd.</b>IN</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Gudang.</b>in</span>
    </a>
